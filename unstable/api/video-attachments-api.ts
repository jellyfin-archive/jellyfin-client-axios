...
/**
 * VideoAttachmentsApi - interface
 * @export
 * @interface VideoAttachmentsApi
 */
export interface VideoAttachmentsApiInterface {
    /**
     * 
     * @summary Get video attachment.
     * @param {string} videoId Video ID.
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof VideoAttachmentsApiInterface
     */
    getAttachment(videoId: string, mediaSourceId: string, index: number, options?: any): AxiosPromise<any>;
 ...
 * @extends {BaseAPI}
 */
export class VideoAttachmentsApi extends BaseAPI implements VideoAttachmentsApiInterface {
    /**
     * 
     * @summary Get video attachment.
     * @param {string} videoId Video ID.
