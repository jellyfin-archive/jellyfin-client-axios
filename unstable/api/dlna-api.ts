 ...
 * @interface DlnaApi
 */
export interface DlnaApiInterface {
    /**
     * 
     * @summary Creates a profile.
     * @param {UNKNOWN_BASE_TYPE} [uNKNOWNBASETYPE] Device profile.
 ...
 * @extends {BaseAPI}
 */
export class DlnaApi extends BaseAPI implements DlnaApiInterface {
    /**
     * 
     * @summary Creates a profile.
     * @param {UNKNOWN_BASE_TYPE} [uNKNOWNBASETYPE] Device profile.
     ...
     * @memberof DlnaApi
     */
    public createProfile(uNKNOWNBASETYPE?: UNKNOWN_BASE_TYPE, options?: any) {
        return DlnaApiFp(this.configuration).createProfile(uNKNOWNBASETYPE, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DlnaApi
     */
    public updateProfile(profileId: string, uNKNOWNBASETYPE?: UNKNOWN_BASE_TYPE, options?: any) {
        return DlnaApiFp(this.configuration).updateProfile(profileId, uNKNOWNBASETYPE, options).then((request) => request(this.axios, this.basePath));
    }
}
