...
export class LibraryApi extends BaseAPI implements LibraryApiInterface {
     ...
     * @memberof LibraryApi
     */
    public postUpdatedMedia(uNKNOWNBASETYPE: UNKNOWN_BASE_TYPE, options?: any) {
        return LibraryApiFp(this.configuration).postUpdatedMedia(uNKNOWNBASETYPE, options).then((request) => request(this.axios, this.basePath));
    }
