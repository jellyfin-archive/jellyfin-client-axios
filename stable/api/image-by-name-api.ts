...
/**
 * ImageByNameApi - interface
 * @export
 * @interface ImageByNameApi
 */
export interface ImageByNameApiInterface {
    /**
     * 
     * @summary Get General Image.
     * @param {string} name The name of the image.
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ImageByNameApiInterface
     */
    getGeneralImage(name: string, type: string, options?: any): AxiosPromise<any>;
 ...
 * @extends {BaseAPI}
 */
export class ImageByNameApi extends BaseAPI implements ImageByNameApiInterface {
    /**
     * 
     * @summary Get General Image.
     * @param {string} name The name of the image.
