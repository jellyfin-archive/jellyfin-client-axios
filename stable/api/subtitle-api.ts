...
export class SubtitleApi extends BaseAPI implements SubtitleApiInterface {
     ...
     * @memberof SubtitleApi
     */
    public uploadSubtitle(itemId: string, uploadSubtitleDto: UploadSubtitleDto, options?: any) {
        return SubtitleApiFp(this.configuration).uploadSubtitle(itemId, uploadSubtitleDto, options).then((request) => request(this.axios, this.basePath));
    }
}
