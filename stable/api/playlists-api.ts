...
export class PlaylistsApi extends BaseAPI implements PlaylistsApiInterface {
     ...
     * @memberof PlaylistsApi
     */
    public createPlaylist(name?: string, ids?: Array<string>, userId?: string, mediaType?: string, createPlaylistDto?: CreatePlaylistDto, options?: any) {
        return PlaylistsApiFp(this.configuration).createPlaylist(name, ids, userId, mediaType, createPlaylistDto, options).then((request) => request(this.axios, this.basePath));
    }
