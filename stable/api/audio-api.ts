...
export class AudioApi extends BaseAPI {
     ...
     * @memberof AudioApi
     */
    public getAudioStream(requestParameters: AudioApiGetAudioStreamRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof AudioApi
     */
    public getAudioStreamByContainer(requestParameters: AudioApiGetAudioStreamByContainerRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof AudioApi
     */
    public headAudioStream(requestParameters: AudioApiHeadAudioStreamRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof AudioApi
     */
    public headAudioStreamByContainer(requestParameters: AudioApiHeadAudioStreamByContainerRequest, options?: AxiosRequestConfig) {
