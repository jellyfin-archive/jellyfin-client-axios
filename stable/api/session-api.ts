...
export class SessionApi extends BaseAPI implements SessionApiInterface {
     ...
     * @memberof SessionApi
     */
    public play(sessionId: string, playCommand: PlayCommand, itemIds: Array<string>, startPositionTicks?: number, mediaSourceId?: string, audioStreamIndex?: number, subtitleStreamIndex?: number, startIndex?: number, options?: any) {
        return SessionApiFp(this.configuration).play(sessionId, playCommand, itemIds, startPositionTicks, mediaSourceId, audioStreamIndex, subtitleStreamIndex, startIndex, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SessionApi
     */
    public sendMessageCommand(sessionId: string, uNKNOWNBASETYPE: UNKNOWN_BASE_TYPE, options?: any) {
        return SessionApiFp(this.configuration).sendMessageCommand(sessionId, uNKNOWNBASETYPE, options).then((request) => request(this.axios, this.basePath));
    }
