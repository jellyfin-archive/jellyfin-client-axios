...
export class SessionApi extends BaseAPI implements SessionApiInterface {
     ...
     * @memberof SessionApi
     */
    public postFullCapabilities(clientCapabilitiesDto: ClientCapabilitiesDto, id?: string, options?: any) {
        return SessionApiFp(this.configuration).postFullCapabilities(clientCapabilitiesDto, id, options).then((request) => request(this.axios, this.basePath));
    }
